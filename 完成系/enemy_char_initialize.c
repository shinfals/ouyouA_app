...
#include "func.h"
 ...
 void enemy_char_initialize(Princess_enemy *pPriE,Princess_support *pPriS){
   ...
   hp=rand()%301+500;//モブのHP２５０〜５００でランダム
   at=rand()%51+200;//モブのATK１５０〜３００でランダム
   df=rand()%21+30;//モブのDEF２０〜５０でランダム
   ...
   Mhp=rand()%301+1200;//中ボスのHP７００〜１４００でランダム
   Mat=rand()%101+250;//中ボスのATK２００〜３５０でランダム
   Mdf=rand()%26+50;//中ボスのDEF３５〜７５でランダム
   ...
   pPriE[7].Hp=5000;//ラスボスのHP
   pPriE[7].Mp=3;//ラスボスのMP
   pPriE[7].Atk=500;//ラスボスのATK
   pPriE[7].Def=100;//ラスボスのDEF
   pPriE[7].Spd=1;//ラスボスのSPD
